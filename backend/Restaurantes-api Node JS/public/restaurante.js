...
function alterar(idrestaurante) {
    fetch("http://127.0.0.1:3333/restaurante/" + idrestaurante)
...
function salvar() {
    ...
    const url = idrestaurante 
        ? "http://127.0.0.1:3333/restaurante/" + idrestaurante
        : "http://127.0.0.1:3333/restaurante";

    const metodo = idrestaurante ? "PUT" : "POST";
...
function listar() {
    ...
    fetch('http://127.0.0.1:3333/restaurante')
     .then(response => response.json())
